        ...
        (new Thread(() -> {
            ...
            if (imgs != null) {
                try {
                    ...
                    MinecraftClient.getInstance().player.addChatMessage(new TranslatableText("panorama.messages.saved").append(new LiteralText(images).copy().setStyle(new Style().setUnderline(true).setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_FILE, file.getAbsolutePath())))), false);
